...
Section 1 to 6 are part of hands-on exercise 3, while **section 7 is ClustGeo method for in-class exercise 3**.
...
Derive spatial distance matrix using [`st_distance()`](https://r-spatial.github.io/sf/reference/geos_measures.html) of sf package.
